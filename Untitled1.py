...
# Pas de layout aan
fig.update_layout(
    title_text='Vergelijking van Indicatoren voor Top 5 Buurten',
    height=900,  # Hoogte aanpassen voor leesbaarheid
